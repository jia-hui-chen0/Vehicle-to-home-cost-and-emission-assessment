...
def deg(num0,num1,charging):
    for county_num in range(num0,num1):         
        ...
        pd.DataFrame([lifecty,qcallst,qcyclst]).to_csv(root_dir+r'Dropbox (University of Michigan)\Ford_CC\Server_168h\Deginterm_1\\'+str(county_num)+'_80Y82_'+['uc','cc','v2h'][charging]+'_B2'+'_cons.csv')
        # if len(ttlst[0]) != 0:
