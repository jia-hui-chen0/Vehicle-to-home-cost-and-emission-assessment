    ...
    for county_numi in range(len(county_num_lst)):
        ...
        for yr in ['2024','2030','2040']:
            ...
            for building in ['_0_0']:
                fnames = os.listdir(outputdir+r'\\Result_db\\Result'+cc_hand+r'\\Results_'+'Y82_'+year+r'\\'+str(county_num)+building)
                ...
                if len(fnames) > 0:
                    ...
                    for fnamei in range(len(fnames)):
                        fname = fnames[fnamei]
                        res = pd.read_csv(outputdir+r'\\Result_db\\Result'+cc_hand+r'\\Results_'+'Y82_'+year+r'\\'+str(county_num)+building+'\\'+fname)
