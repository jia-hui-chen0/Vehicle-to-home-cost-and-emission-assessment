...
# num0,num1,year,cc_ip,urb,car,lcc=0,1,2024,0,0,0,0
    ...
    ctydf = pd.read_csv(r'C:\Users\jiahuic\Dropbox (University of Michigan)\Ford_CC\2020_Gaz_counties_national_0728_tempreg.csv')
    ...
    df2.to_csv(outputdir+r'\\Server_168h\csvs\\'
