    ...
    for county_num in range(num0,num1):
        for i1 in range(1):
            for i2 in range(1):
                ...
                try:
                    os.mkdir(r'C:\Users\jiahuic\Dropbox (University of Michigan)\Ford_CC\ResStock\dischargecons_Y82\\')
                except:pass
                try:
                    os.mkdir(r'C:\Users\jiahuic\Dropbox (University of Michigan)\Ford_CC\ResStock\dischargecons_Y82\\'+str(county_num)+'_'+
                                                                str(i1)+'_'+str(i2)+'\\')
                except:pass
                for fnm in fnms:
                    ...
                    for fnm_ev in fnms_ev:
                        ...
                        pd.DataFrame(cons,columns=['CR']).to_csv(r'C:\Users\jiahuic\Dropbox (University of Michigan)\Ford_CC\ResStock\dischargecons_Y82\\'+str(county_num)+'_'+
                                                                str(i1)+'_'+str(i2)+'\\'+
                                                                fnm_ev[:-8]+fnm[-7:])
