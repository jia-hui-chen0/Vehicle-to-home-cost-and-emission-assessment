        ...
        for fname in fnames[:5]:
            ...
            if cari==0 and urbi ==0 and lcci==0:
                ...
                if results[2][1]!=60*0.3:
                    ...
                    try:os.mkdir(outputdir+r'\\Results\\Results_80_60_1\\')
                    except:pass
                    try:
                        os.mkdir(outputdir+r'\\Results\\Results_80_60_1\\'+str(county_num)+r'\\')
                    except:
                        pass
                    df_res.T.to_csv(outputdir+r'\\Results\\Results_80_60_1\\'+str(county_num)+r'\\'+fname)
