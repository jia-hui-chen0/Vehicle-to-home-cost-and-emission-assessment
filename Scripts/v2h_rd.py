...
execute_unload "results.gdx" sc fc vSOC sd; '''
    ...
    for county_num in range(num0,num1):
        ...
        fnames = [i for i in fnames if i not in os.listdir(outputdir+r'\\Result_v2h\\Results_80_Y82_2040\\'+str(county_num)+'_'+str(i1)+'_'+str(i2)+r'\\')]
            ...
            for year in [years]:
                ...
                for i1 in range(1):
                    for i2 in range(1):
                        ...
                        # try: 
                        #     # os.mkdir(outputdir+r'\\Results_opt_3\\')
                        #     os.mkdir(outputdir+r'\\Result_v2h\\Results_80_Y82_'+str(year)+r'_1\\')
                        # except: pass
                        # try: os.mkdir(outputdir+r'\\Result_v2h\\Results_80_Y82_'+str(year)+r'_1\\'+str(county_num)+'_'+str(i1)+'_'+str(i2)+r'\\')
                        # except: pass
                        df_res.T.to_csv(outputdir+r'\\Result_v2h\\Results_80_Y82'+str(year)+r'\\'+str(county_num)+'_'+str(i1)+'_'+str(i2)+r'\\'+fname_evhh)
