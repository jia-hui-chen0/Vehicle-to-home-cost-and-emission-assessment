        ...
        for fname_i in range(len(fnames)):
            ...
            for year in years:
                ...
                try: 
                    ...
                    os.mkdir(outputdir+r'//Result_cc_1//Results_'+str(year)+r'//')
                except: pass
                try: os.mkdir(outputdir+r'//Result_cc_1//Results_'+str(year)+r'//'+str(county_num)+'_'+str(0)+'_'+str(0)+r'//')
                except: pass
                df_res.T.to_csv(outputdir+r'//Result_cc_1//Results_'+str(year)+r'//'+str(county_num)+'_'+str(0)+'_'+str(0)+r'//'+fname)
...
if __name__ == '__main__':
    ...
    CC(rank*4,(rank+1)*4,[2024,2030,2040])
