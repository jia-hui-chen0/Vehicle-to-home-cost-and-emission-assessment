...
SOC = [28*3.3,153]
fnames = os.listdir(driving_profile_foldername)[0:40]
    ...
    for county_num in range(num0,num1):
        ...
        for fname in fnames:
            ...
            if cari==0 and urbi ==0 and lcci==0:
                ...
                df0 = pd.read_csv(outputdir+r'/Energy consumption_adjusted/'+str(county_num)+r'/'+veh_fname+'_0_soc.csv')
